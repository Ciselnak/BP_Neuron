...
Soubor vznikl úpravou souboru Petra Chlumského. Změnil jsem vzhled a rozšířil popis kódu. Dále jsem odstranil nepřesné a nepravdivé popisky u vytváření RBF sítě a nahradil pravdivou verzí.
\subsection{Iris data}
\subsection{Různé přístupy k učení sítě}
\section{Hopfieldova síť}
\section{Samoorganizující mapy}
